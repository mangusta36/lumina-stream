...
export default function SupportPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "yes, flash 4k iptv offers a 7-day money-back guarantee for any technical issues we cannot solve."
    },
    {
      q: "can i use flash 4k iptv on multiple devices?",
      ...
      <div className="max-w-7xl mx-auto pt-48 pb-20 px-6">
        ...
        <div className="text-center mb-24 relative">
          ...
          <div className="inline-flex items-center gap-2 bg-green-500/10 border border-green-500/20 px-5 py-2 rounded-full mb-10">
            ...
            <span className="text-green-500 text-[10px] font-bold tracking-widest">flash 4k iptv servers: online</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 leading-none italic">
            flash 4k <span className="text-primary not-italic text-6xl md:text-8xl">iptv</span> support.
          </h1>
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto font-medium italic lowercase">
            need help with your flash 4k iptv subscription? our technical team is available 24/7 on whatsapp.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-32 max-w-5xl mx-auto">
          ...
          {/* WhatsApp Card */}
          <a 
            href="https://wa.me/447828714977?text=Hello! I need help with my Flash 4K IPTV subscription. Can you assist?" 
            target="_blank"
          ...
          >
             ...
             <p className="text-gray-400 text-base mb-10 leading-relaxed font-medium">step-by-step tutorials for flash 4k iptv on all devices (smart tv, firestick, etc).</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black mb-6 italic tracking-tighter">flash 4k <span className="text-primary italic">faq</span></h2>
        ...
        <div className="mt-32 flex flex-col items-center">
            <div className="flex items-center gap-4 bg-white/5 px-10 py-5 rounded-full border border-white/10">
              ...
              <span className="text-[11px] font-bold tracking-[0.4em] text-gray-400 lowercase">flash 4k iptv secure support</span>
            </div>
        </div>
