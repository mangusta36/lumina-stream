// src/lib/posts/iptv-sports-fans-2026-guide.ts
      ...
      <section class="bg-white/5 p-10 rounded-[3rem] border border-white/10 my-12 shadow-2xl relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 italic font-bold text-center">
          <div class="p-6 bg-black/40 rounded-2xl border border-white/5 shadow-inner">
            <h4 class="text-white uppercase text-sm mb-2">soccer channels</h4>
            <p class="text-3xl text-primary font-black">250+</p>
            <p class="text-xs text-gray-400 mt-1 italic font-normal">sky sports, bt sport, bein sports, espn, and more</p>
          </div>
          <div class="p-6 bg-black/40 rounded-2xl border border-white/5 shadow-inner">
            <h4 class="text-white uppercase text-sm mb-2">us sports</h4>
            <p class="text-3xl text-primary font-black">180+</p>
            <p class="text-xs text-gray-400 mt-1 italic font-normal">nfl, nba, mlb, nhl, nascar, and college sports</p>
          </div>
          <div class="p-6 bg-black/40 rounded-2xl border border-white/5 shadow-inner">
            <h4 class="text-white uppercase text-sm mb-2">combat & motorsports</h4>
            <p class="text-3xl text-primary font-black">120+</p>
            <p class="text-xs text-gray-400 mt-1 italic font-normal">boxing, ufc, wwe, f1, motogp, and rally coverage</p>
          </div>
        </div>
      </section>
        ...
        <div class="bg-black/40 p-6 rounded-2xl mt-8 border-l-4 border-primary">
          ...
          <div class="grid grid-cols-2 gap-4 mt-4 text-sm">
            <div class="bg-black/30 p-3 rounded-xl">
              <strong class="text-white">2x2 grid:</strong>
              <p class="text-gray-400 italic">four equal quadrants — ideal for monitoring multiple games simultaneously, such as nfl redzone plus three other matchups.</p>
            </div>
            <div class="bg-black/30 p-3 rounded-xl">
            ...
            <div class="bg-black/30 p-3 rounded-xl">
              ...
              <p class="text-gray-400 italic">picture-in-picture with one small overlay — useful for keeping a second game visible while focusing on the main broadcast.</p>
            </div>
          </div>
        </div>
      </section>
